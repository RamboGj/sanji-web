...
export function UseSnipeListFalseWarning() {
  return (
    <div className="absolute bottom-0 left-0 right-0 top-0 z-10 flex justify-center rounded-xl bg-gray900/95">
      <div className="border-warning800/60 bg-warning800/15 mt-24 flex max-h-[140px] w-full max-w-[465px] flex-col items-center justify-center gap-3 rounded-xl border px-9 text-center">
